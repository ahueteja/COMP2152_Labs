...
#  COMP2152 — Anthony Huete-Jacobs  
# ============================================================


# you can connect you IP address through public IP addresses - there can also be private ones 
# 
...
class TestValidIP(unittest.TestCase):
    ...
    def test_invalid_octet(self):
        self.assertFalse(is_valid_ip("292.168.1.1"))
